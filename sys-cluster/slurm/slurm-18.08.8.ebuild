...
inherit autotools bash-completion-r1 eapi7-ver eutils pam perl-module prefix systemd toolchain-funcs user
...
LICENSE="GPL-2"
SLOT="0"
IUSE="debug hdf5 html ipmi json lua multiple-slurmd +munge mysql netloc numa ofed pam perl slurmdbd ssl static-libs systemd torque X"
