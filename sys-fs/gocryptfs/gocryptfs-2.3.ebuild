...
EGO_SUM=(
	...
	"github.com/hanwen/go-fuse/v2 v2.1.1-0.20211219085202-934a183ed914/go.mod"
...
SRC_URI="https://github.com/rfjakob/${PN}/releases/download/v${PV}/${PN}_v${PV}_src.tar.gz
	${EGO_SUM_SRC_URI}"
