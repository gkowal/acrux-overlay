...
GITHUB_BRANCH="release-1.22"
GITHUB_COMMIT="4ba0ced"
EGO_SUM=(
	...
	"cloud.google.com/go/pubsub v1.18.0/go.mod"
	...
	"github.com/Azure/azure-amqp-common-go/v3 v3.2.3/go.mod"
	"github.com/Azure/azure-event-hubs-go/v3 v3.3.17"
	"github.com/Azure/azure-event-hubs-go/v3 v3.3.17/go.mod"
	"github.com/Azure/azure-kusto-go v0.5.2"
	"github.com/Azure/azure-kusto-go v0.5.2/go.mod"
	...
	"github.com/Azure/azure-sdk-for-go v61.2.0+incompatible/go.mod"
	...
	"github.com/Flaque/filet v0.0.0-20201012163910-45f684403088/go.mod"
	...
	"github.com/aerospike/aerospike-client-go/v5 v5.7.0/go.mod"
	...
	"github.com/alecthomas/participle v0.4.1/go.mod"
	...
	"github.com/aliyun/alibaba-cloud-sdk-go v1.61.1483/go.mod"
	...
	"github.com/antchfx/jsonquery v1.1.5/go.mod"
	"github.com/antchfx/xmlquery v1.3.9"
	"github.com/antchfx/xmlquery v1.3.9/go.mod"
	...
	"github.com/apache/arrow/go/arrow v0.0.0-20211006091945-a69884db78f4/go.mod"
	...
	"github.com/apex/log v1.6.0/go.mod"
	...
	"github.com/ashanbrown/forbidigo v1.1.0/go.mod"
	"github.com/ashanbrown/makezero v0.0.0-20201205152432-7b7cdbb3025a/go.mod"
	...
	"github.com/aws/aws-sdk-go-v2 v1.8.0/go.mod"
	"github.com/aws/aws-sdk-go-v2 v1.8.0/go.mod"
	"github.com/aws/aws-sdk-go-v2 v1.8.1/go.mod"
	...
	"github.com/aws/aws-sdk-go-v2/aws/protocol/eventstream v1.2.0/go.mod"
	"github.com/aws/aws-sdk-go-v2/config v1.6.0/go.mod"
	"github.com/aws/aws-sdk-go-v2/config v1.6.0/go.mod"
	"github.com/aws/aws-sdk-go-v2/config v1.6.1/go.mod"
	"github.com/aws/aws-sdk-go-v2/config v1.8.2/go.mod"
	"github.com/aws/aws-sdk-go-v2/config v1.13.1"
	"github.com/aws/aws-sdk-go-v2/config v1.13.1/go.mod"
	"github.com/aws/aws-sdk-go-v2/credentials v1.3.2/go.mod"
	"github.com/aws/aws-sdk-go-v2/credentials v1.3.2/go.mod"
	"github.com/aws/aws-sdk-go-v2/credentials v1.3.3/go.mod"
	"github.com/aws/aws-sdk-go-v2/credentials v1.4.2/go.mod"
	"github.com/aws/aws-sdk-go-v2/credentials v1.8.0"
	"github.com/aws/aws-sdk-go-v2/credentials v1.8.0/go.mod"
	...
	"github.com/aws/aws-sdk-go-v2/feature/ec2/imds v1.5.1/go.mod"
	"github.com/aws/aws-sdk-go-v2/feature/ec2/imds v1.10.0/go.mod"
	...
	"github.com/aws/aws-sdk-go-v2/feature/s3/manager v1.5.3/go.mod"
	"github.com/aws/aws-sdk-go-v2/internal/configsources v1.0.2/go.mod"
	"github.com/aws/aws-sdk-go-v2/internal/configsources v1.0.2/go.mod"
	...
	"github.com/aws/aws-sdk-go-v2/internal/ini v1.2.3/go.mod"
	"github.com/aws/aws-sdk-go-v2/internal/ini v1.3.5"
	"github.com/aws/aws-sdk-go-v2/internal/ini v1.3.5/go.mod"
	"github.com/aws/aws-sdk-go-v2/service/cloudwatch v1.7.0"
	"github.com/aws/aws-sdk-go-v2/service/cloudwatch v1.7.0/go.mod"
	"github.com/aws/aws-sdk-go-v2/service/cloudwatchlogs v1.13.0"
	"github.com/aws/aws-sdk-go-v2/service/cloudwatchlogs v1.13.0/go.mod"
	"github.com/aws/aws-sdk-go-v2/service/dynamodb v1.5.0/go.mod"
	"github.com/aws/aws-sdk-go-v2/service/dynamodb v1.14.0"
	"github.com/aws/aws-sdk-go-v2/service/dynamodb v1.14.0/go.mod"
	...
	"github.com/aws/aws-sdk-go-v2/service/internal/accept-encoding v1.8.0/go.mod"
	"github.com/aws/aws-sdk-go-v2/service/internal/endpoint-discovery v1.0.2/go.mod"
	...
	"github.com/aws/aws-sdk-go-v2/service/internal/endpoint-discovery v1.6.0/go.mod"
	...
	"github.com/aws/aws-sdk-go-v2/service/internal/presigned-url v1.3.1/go.mod"
	...
	"github.com/aws/aws-sdk-go-v2/service/sts v1.7.1/go.mod"
	...
	"github.com/aws/aws-sdk-go-v2/service/timestreamwrite v1.3.2"
	"github.com/aws/aws-sdk-go-v2/service/timestreamwrite v1.3.2/go.mod"
	"github.com/aws/aws-sdk-go-v2/service/timestreamwrite v1.3.2/go.mod"
	...
	"github.com/awslabs/kinesis-aggregation/go v0.0.0-20210630091500-54e17340d32f/go.mod"
	...
	"github.com/bombsimon/wsl/v3 v3.2.0/go.mod"
	...
	"github.com/doclambda/protobufquery v0.0.0-20210317203640-88ffabe06a60/go.mod"
	...
	"github.com/dstrand1/riemann-go-client v0.5.1-0.20211028194734-b5eb11fb5754/go.mod"
	...
	"github.com/dynatrace-oss/dynatrace-metric-utils-go v0.3.0/go.mod"
	...
	"github.com/esimonov/ifshort v1.0.1/go.mod"
	...
	"github.com/go-critic/go-critic v0.5.4/go.mod"
	...
	"github.com/golangci/golangci-lint v1.38.0/go.mod"
	...
	"github.com/golangci/revgrep v0.0.0-20210208091834-cd28932614b5/go.mod"
	...
	"github.com/gopcua/opcua v0.3.1/go.mod"
	"github.com/gophercloud/gophercloud v0.16.0/go.mod"
	"github.com/gophercloud/gophercloud v0.24.0"
	"github.com/gophercloud/gophercloud v0.24.0/go.mod"
	...
	"github.com/gosnmp/gosnmp v1.34.0/go.mod"
	...
	"github.com/grid-x/modbus v0.0.0-20211113184042-7f2251c342c9/go.mod"
	...
	"github.com/grid-x/serial v0.0.0-20211107191517-583c7356b3aa/go.mod"
	...
	"github.com/gwos/tcg/sdk v0.0.0-20211223101342-35fbd1ae683c/go.mod"
	...
	"github.com/harlow/kinesis-consumer v0.3.6-0.20210911031324-5a873d6e9fec/go.mod"
	...
	"github.com/influxdata/influxdb-observability/common v0.2.10/go.mod"
	"github.com/influxdata/influxdb-observability/influx2otel v0.2.10"
	"github.com/influxdata/influxdb-observability/influx2otel v0.2.10/go.mod"
	"github.com/influxdata/influxdb-observability/otel2influx v0.2.10"
	"github.com/influxdata/influxdb-observability/otel2influx v0.2.10/go.mod"
	...
	"github.com/influxdata/line-protocol-corpus v0.0.0-20210519164801-ca6fa5da0184/go.mod"
	"github.com/influxdata/line-protocol-corpus v0.0.0-20210922080147-aa28ccfb8937"
	"github.com/influxdata/line-protocol-corpus v0.0.0-20210922080147-aa28ccfb8937/go.mod"
	"github.com/influxdata/line-protocol/v2 v2.0.0-20210312151457-c52fdecb625a/go.mod"
	"github.com/influxdata/line-protocol/v2 v2.1.0/go.mod"
	"github.com/influxdata/line-protocol/v2 v2.2.1"
	"github.com/influxdata/line-protocol/v2 v2.2.1/go.mod"
	...
	"github.com/intel/iaevents v1.0.0/go.mod"
	...
	"github.com/jaegertracing/jaeger v1.22.0/go.mod"
	"github.com/jaegertracing/jaeger v1.23.0/go.mod"
	"github.com/jaegertracing/jaeger v1.26.0"
	"github.com/jaegertracing/jaeger v1.26.0/go.mod"
	...
	"github.com/jhump/protoreflect v1.8.3-0.20210616212123-6cc1efa697ca/go.mod"
	"github.com/jingyugao/rowserrcheck v0.0.0-20210130005344-c6a0c12dd98d/go.mod"
	...
	"github.com/julz/importas v0.0.0-20210226073942-60b4fa260dd0/go.mod"
	...
	"github.com/mdlayher/genetlink v1.1.0/go.mod"
	...
	"github.com/mozilla/tls-observatory v0.0.0-20201209171846-0547674fceff/go.mod"
	...
	"github.com/multiplay/go-ts3 v1.0.1/go.mod"
	...
	"github.com/olivere/elastic/v7 v7.0.12/go.mod"
	...
	"github.com/prometheus/common v0.25.0/go.mod"
	...
	"github.com/prometheus/prometheus v1.8.2-0.20210430082741-2a4b8e12bbf2/go.mod"
	...
	"github.com/quasilyte/go-ruleguard v0.3.0/go.mod"
	"github.com/quasilyte/go-ruleguard/dsl v0.0.0-20210106184943-e47d54850b18/go.mod"
	"github.com/quasilyte/go-ruleguard/dsl v0.0.0-20210115110123-c73ee1cbff1f/go.mod"
	...
	"github.com/sanposhiho/wastedassign v0.1.3/go.mod"
	"github.com/sbezverk/nx-telemetry-proto v0.0.0-20210629125746-3c19a51b1abc"
	"github.com/sbezverk/nx-telemetry-proto v0.0.0-20210629125746-3c19a51b1abc/go.mod"
	...
	"github.com/securego/gosec/v2 v2.6.1/go.mod"
	...
	"github.com/sensu/sensu-go/api/core/v2 v2.13.0/go.mod"
	...
	"github.com/showwin/speedtest-go v1.1.4/go.mod"
	...
	"github.com/sleepinggenius2/gosmi v0.4.4/go.mod"
	...
	"github.com/smartystreets/gunit v1.1.3/go.mod"
	"github.com/snowflakedb/gosnowflake v1.6.2"
	"github.com/snowflakedb/gosnowflake v1.6.2/go.mod"
	...
	"github.com/testcontainers/testcontainers-go v0.12.0/go.mod"
	"github.com/tetafro/godot v1.4.4/go.mod"
	...
	"github.com/tj/go-buffer v1.0.1/go.mod"
	...
	"github.com/tommy-muehle/go-mnd/v2 v2.3.1/go.mod"
	...
	"github.com/vapourismo/knx-go v0.0.0-20211128234507-8198fa17db36/go.mod"
	...
	"github.com/vmware/govmomi v0.27.3/go.mod"
	...
	"github.com/wavefronthq/wavefront-sdk-go v0.9.10/go.mod"
	...
	"github.com/xdg-go/scram v1.1.0/go.mod"
	...
	"go.mongodb.org/mongo-driver v1.5.2/go.mod"
	...
	"go.opentelemetry.io/collector v0.28.0/go.mod"
	"go.opentelemetry.io/collector/model v0.39.0/go.mod"
	"go.opentelemetry.io/collector/model v0.44.0"
	"go.opentelemetry.io/collector/model v0.44.0/go.mod"
	...
	"go.opentelemetry.io/otel/exporters/otlp/otlpmetric v0.27.0/go.mod"
	"go.opentelemetry.io/otel/exporters/otlp/otlpmetric/otlpmetricgrpc v0.27.0"
	"go.opentelemetry.io/otel/exporters/otlp/otlpmetric/otlpmetricgrpc v0.27.0/go.mod"
	...
	"go.opentelemetry.io/otel/sdk/metric v0.27.0/go.mod"
	...
	"golang.org/x/net v0.0.0-20211108170745-6635138e15ea/go.mod"
	...
	"golang.org/x/net v0.0.0-20211208012354-db4efeb81f4b/go.mod"
	...
	"golang.org/x/tools v0.0.0-20210102185154-773b96fafca2/go.mod"
	...
	"golang.zx2c4.com/go118/netip v0.0.0-20211111135330-a4a02eeacf9d/go.mod"
	"golang.zx2c4.com/wintun v0.0.0-20211104114900-415007cec224/go.mod"
	"golang.zx2c4.com/wireguard v0.0.0-20211129173154-2dd424e2d808/go.mod"
	"golang.zx2c4.com/wireguard v0.0.0-20211209221555-9c9e7e272434"
	"golang.zx2c4.com/wireguard v0.0.0-20211209221555-9c9e7e272434/go.mod"
	"golang.zx2c4.com/wireguard/wgctrl v0.0.0-20211230205640-daad0b7ba671"
	"golang.zx2c4.com/wireguard/wgctrl v0.0.0-20211230205640-daad0b7ba671/go.mod"
	...
	"gopkg.in/olivere/elastic.v5 v5.0.86/go.mod"
	...
	"honnef.co/go/tools v0.1.2/go.mod"
	...
	"k8s.io/apimachinery v0.23.3/go.mod"
	...
	"k8s.io/client-go v0.23.3/go.mod"
