...
src_configure() {
	...
	local mycmakeargs=(
		...
		# VitIt bridge
		-DPARAVIEW_USE_VISITBRIDGE="$(usex visit)"
...
src_install() {
	...
	# remove incorrect documentation directory
	rm "${ED}"/usr/share/doc/paraview-${MAJOR_PV}/*
	rmdir "${ED}"/usr/share/doc/paraview-${MAJOR_PV}
}
