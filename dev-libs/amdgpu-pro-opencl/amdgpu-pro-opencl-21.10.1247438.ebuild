...
HOMEPAGE="https://www.amd.com/en/support/kb/release-notes/rn-amdgpu-unified-linux-21-10"
...
pkg_nofetch() {
	...
	einfo "Please download Radeon Software for Linux version ${pkgver} for Ubuntu 20.04.2 from"
	einfo "    ${HOMEPAGE}"
